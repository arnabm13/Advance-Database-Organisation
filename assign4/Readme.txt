...
Step 1: Run make command
Step 2: Run ./test_assign4
...
Note: We have taken the reference of implementation of double link list from the below mentioned website
http://www.sanfoundry.com/c-program-doubly-linked-list/
